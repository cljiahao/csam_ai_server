...
const Folders = ({ openMenu }) => {
  ...
  return (
    <div className="h-full w-full 2xl:text-lg">
      <div className="flex h-[10%] w-full items-center justify-between rounded-lg bg-yellow-500 px-2 text-center 2xl:h-[8%] 2xl:px-3">
      ...
      <div className="flex h-[10%] w-full items-center justify-end gap-3 rounded-lg bg-green-500 p-3 2xl:h-[8%] 2xl:gap-5 2xl:p-5">
        <ButtonCont
          count={count}
          setCount={setCount}
          folders={folders}
